...
if __name__ == '__main__':
    ...
    if stat:
        ...
        axe.text(0, ymax*.98,
                 fr"mean$_y$: {x_mean*.1:.1f} cm, $\sigma_x$: {x_std*.1:.1f} cm, " +
    ...
    axe = axes[1]
    axe.set_title("Euler angle")
    axe.plot(time, Y, '.:r', markersize=marker_size, linewidth=0.3, label="Y euler angle")
    axe.set_ylabel("Radian")
    axe.set_xlabel(x_label)
    ymax = -4
    axe.set_ylim(-ymax, ymax)
    if stat:
        ...
        text1 = f"x_mean: {y_mean*.1:.1f} cm, y_std: {y_std*.1:.1f} cm"
    ...
    axe = axes[2]
    axe.set_title("Euler angle")
    axe.plot(time, Z, '.:g', markersize=marker_size, linewidth=0.3, label="Z euler angle")
    axe.set_ylabel("Radian")
    axe.set_xlabel(x_label)
    ymax = -4
    axe.set_ylim(-ymax, ymax)
    if stat:
        ...
        text1 = f"x_mean: {z_mean*.1:.1f} cm, z_std: {z_std*.1:.1f} cm"
