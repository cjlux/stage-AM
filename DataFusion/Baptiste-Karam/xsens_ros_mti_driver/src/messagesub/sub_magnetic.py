...
class xsens_mti_listener_mag:
	...
	'''
        ...
        fb_data = data.vector.split(":")                        # Retrieve the magnetic forces in x, y and z
...
if __name__ == '__main__':
   ...
   uniq_file_name = f"./Data_MTi_magnetic_"
   if file_prefix != "":
   ...
   with open(uniq_file_name, "w") as f:
        ...
        listener = xsens_mti_listener_mag(f)
        ...
        # run simultaneously.
        rospy.init_node('xsens_mti_listener_mag', anonymous = True)
